---
name: delivery-status-brief
description: "Create a clear project status brief with progress, risks, blockers, decisions, and next actions."
---
...
- **Audience** (steering committee / sponsor / project management office / full team)
...
**Period:** [Date range] | **Author:** [product management] | **Next report:** [Date]
