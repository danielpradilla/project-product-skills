...
description: "Investigate retention patterns, cohorts, drivers, warning signs, and intervention options."
---
...
A product with Product-market fit has a retention curve that flattens. If it trends to zero, you have a Product-market fit problem, not an onboarding problem. Name this distinction explicitly.
...
**Product-market fit Signal:** [Strong / Weak / Absent - based on curve shape]
...
- [ ] Retention curve shape is diagnosed (flattening vs trending to zero = Product-market fit vs onboarding)
...
- If DAU/MAU is below 5%, that's a Product-market fit conversation, not a retention tactics conversation
