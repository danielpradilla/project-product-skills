---
name: job-to-be-done-map
description: "Frame jobs, triggers, desired outcomes, anxieties, and product opportunities."
---

# Job To Be Done Map

Stop writing features. Start understanding jobs. Use this workflow to translate product requirements and user interviews into precise job stories that keep the team focused on outcomes - not outputs.
...
**The situation is the most important part.** "When I'm in the middle of a sprint and my product management asks for an update" is a much richer trigger than "As a developer."
