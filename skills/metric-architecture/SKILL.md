...
description: "Design product metric trees, North Star metrics, input metrics, and instrumentation needs."
---

# Metric Architecture

Use this workflow to build a complete metrics framework tailored to a product or business. It connects the North Star metric to actionable leading indicators, making it clear which metrics to track, which to optimise, and how they relate to each other.
...
- **Stage** (Pre-product-market fit / Growth / Scale / Mature)
