...
description: "Turn sprint inputs into a kickoff-ready brief with goals, tickets, risks, and team context."
---

# Sprint Kickoff Brief

Produce a clear, scannable sprint brief that every team member - engineer, designer, product management - can read in under three minutes and understand exactly what we're doing and why.
